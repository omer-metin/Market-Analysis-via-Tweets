...
RESULT_FILE_NAME = time.strftime("decision_tree_test_%y-%m-%d_%H-%M-%S.csv",
...
PARAMETER = {'criterion': 'entropy', 'max_depth': 7}
...
PARAMETERS = [{'criterion': 'gini', 'max_depth': None},
              ...
              {'criterion': 'gini', 'max_depth': 47},
              {'criterion': 'gini', 'max_depth': 107},
              {'criterion': 'gini', 'max_depth': 613},
              {'criterion': 'gini', 'max_depth': 1001},
              {'criterion': 'gini', 'max_depth': 10001},
              ...
              {'criterion': 'entropy', 'max_depth': 107},
              {'criterion': 'entropy', 'max_depth': 613},
              {'criterion': 'entropy', 'max_depth': 1001},
              {'criterion': 'entropy', 'max_depth': 10001}]
...
if not THRESH_TEST:
    ...
    if WRITE_FILE:
        ...
        result_file.write(f"Method: Decision Tree\n")
